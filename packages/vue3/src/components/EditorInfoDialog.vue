...
<template>
  <div v-if="isRendered" class="editor-info-dialog" :class="[`editor-info-dialog--${device}`, { 'is-open': isOpen }]">
      ...
      <div class="editor-info-dialog__panel" role="dialog" aria-modal="true" aria-labelledby="editor-info-dialog-title">
        ...
        <div class="editor-info-dialog__body">
          ...
          <div class="editor-info-dialog__meta">
            <span class="editor-info-dialog__version">v{{ pkg ? pkg.version : '0.1.6' }}</span>
          ...
          <div class="editor-info-dialog__links">
            <a
              href="https://github.com/longjianghu/bamboo-editor"
              target="_blank"
              rel="noopener noreferrer"
              class="editor-info-dialog__link"
            >
